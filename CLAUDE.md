...
1. **Check `.agentic/AGENTS_ACTIVE.md`** for coordination
...
**This is the Agentic Framework repo.**

For framework-specific guidance:
- `.agentic/FRAMEWORK_QUICK_START.md` - What we're building
- `.agentic/FRAMEWORK_DEVELOPMENT.md` - Full development guide
- `tests/validate_framework.sh` - Must pass before committing
