...
- ✅ `OVERVIEW.md` - What we're building, what's done, what's next
...
1. **Read the product**: `OVERVIEW.md` tells you what's being built, what's done, and what's in scope
2. **Ask user for direction**: "Which capability from OVERVIEW.md should I work on?" or "What's the priority?"
...
4. **Document as you go**: 
   ...
   - Update `OVERVIEW.md` when you complete capabilities or make technical decisions
   - Check off items in `OVERVIEW.md` "Core capabilities" when done
