...
## How to use
- Agents should add entries when they encounter situations requiring human judgment
- Humans review this file to understand what needs attention
- Once resolved, move item to "Resolved" section or delete
- Keep this file short - resolve items promptly

---

## Active items needing attention

### HN-0001: [Short description]
- **Type**: decision | bug | refactor | security | external
- **Added**: YYYY-MM-DD
- **Context**:
  - <!-- What is the situation? -->
- **Why human needed**:
  - <!-- Why can't agent resolve this? -->
- **Options** (if applicable):
  - Option A: pros/cons
  - Option B: pros/cons
- **Impact**:
  - Blocking: <!-- feature IDs or tasks blocked by this -->
  - Affects: <!-- what areas are impacted -->
- **Agent recommendation** (optional):
  - <!-- Agent's suggested approach if any -->

---

## Example entries (delete these in real use)
...
## Resolved (keep for reference, archive periodically)

### HN-0001: Payment provider decision
- **Resolved**: 2025-12-16
- **Decision**: Chose Stripe
- **Outcome**: Implemented in F-0023
