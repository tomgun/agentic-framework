...
**Current version:** [v0.4.0](https://github.com/tomgun/agentic-framework/releases/tag/v0.4.0)
...
curl -L https://github.com/tomgun/agentic-framework/archive/refs/tags/v0.4.0.tar.gz | tar xz
cd agentic-framework-0.4.0
