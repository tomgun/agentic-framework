...
**Current version:** [v0.3.1](https://github.com/tomgun/agentic-framework/releases/tag/v0.3.1)
...
curl -L https://github.com/tomgun/agentic-framework/archive/refs/tags/v0.3.1.tar.gz | tar xz
cd agentic-framework-0.3.1
