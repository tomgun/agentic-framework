...
**Current version:** [v0.9.3](https://github.com/tomgun/agentic-framework/releases/tag/v0.9.3)
...
cp -r agentic-framework-0.9.3/.agentic /path/to/your-project/
```
...
bash /tmp/agentic-framework-0.9.3/.agentic/tools/upgrade.sh /path/to/your-project

# Clean up
rm -rf /tmp/agentic-framework-0.9.3
```
