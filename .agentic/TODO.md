...
- **Added**: 2026-03-10
- **Resolved**: 2026-03-11 — Implemented as advisory check 17 in pre-commit-check.sh. Scans in_progress features for unchecked ACs and emits non-blocking warning.
