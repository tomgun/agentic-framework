...
cd /tmp
curl -L https://github.com/tomgun/agentic-framework/archive/refs/tags/v0.18.0.tar.gz | tar xz

# Run upgrade tool FROM the new framework
bash /tmp/agentic-framework-0.18.0/.agentic/tools/upgrade.sh /path/to/your-project

# Clean up
rm -rf /tmp/agentic-framework-0.18.0
```
