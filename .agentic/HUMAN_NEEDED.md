...
<!-- Use format: HN-####: [description] with Type, Context, Why human needed, Options, Impact -->
...
### HN-0080: PR #220: F-041 Phase 3 — bootstrap + quality intelligence
- **Type**: pr_review
- **Added**: 2026-04-02
- **Context**: feat/F-041-phase3-bootstrap-quality → main. Adds ag intel bootstrap + retro commands.
- **Why human needed**: Requires human action/decision
- **Impact**: Blocking: [specify what's blocked]



### HN-0081: PR #221: F-041 Phase 4 — phase-aware queries
- **Type**: pr_review
- **Added**: 2026-04-02
- **Context**: Intelligence engine Phase 4: 4 phase-aware query commands + skill integration + docs
- **Why human needed**: Requires human action/decision
- **Impact**: Blocking: [specify what's blocked]
...
- **Resolved**: 2026-05-02
- **Outcome**: Merged as commit dd38f82a on main
