...
6. Write comprehensive plan to `.agentic-state/plans/F-XXXX-plan.md`
...
Create Plan:
Write to: .agentic-state/plans/{FEATURE_ID}-plan.md
...
→ After creating/revising plan: "Plan ready for review at .agentic-state/plans/F-XXXX-plan.md"
...
Task tool:
  ...
  prompt: "Create implementation plan for F-0042.
           ...
           Write to: .agentic-state/plans/F-0042-plan.md
