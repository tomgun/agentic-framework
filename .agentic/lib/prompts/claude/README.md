...
2. Paste the framework guidelines:
   - Core instruction: "Follow .agentic/lib/agents/shared/agent_operating_guidelines.md"
...
2. Add custom instructions:
   ...
   Follow .agentic/lib/agents/shared/agent_operating_guidelines.md strictly.
...
3. Add key files as project context:
   - `.agentic/STATUS.md`
   - `.agentic/spec/FEATURES.md` (if Formal mode)
   - `STACK.md`
...
**Setup**: See [`.agentic/lib/claude-hooks/README.md`](../../claude-hooks/README.md) for full documentation.
