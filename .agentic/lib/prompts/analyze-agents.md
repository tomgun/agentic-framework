...
See `.agentic/lib/agents/roles/` for templates.
To create a new agent: `bash .agentic/lib/tools/create-agent.sh [name]`
```
...
See `.agentic/lib/agents/roles/` for example agent definitions:
