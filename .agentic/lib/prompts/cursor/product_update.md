...
I've made changes to the project and need to update `.agentic/OVERVIEW.md`.
...
6. **Commit together:**
   - Commit code changes + `.agentic/OVERVIEW.md` + `JOURNAL.md` together
   - Use descriptive commit message

---

**OVERVIEW.md is your lightweight spec:**
- In Discovery mode, it replaces the formal `.agentic/spec/FEATURES.md`
