...
1. **Read the feature spec:**
   - Check `.agentic/spec/FEATURES.md` for F-[XXXX]
   - Read acceptance criteria at `.agentic/spec/acceptance/F-[XXXX].md`
...
**Reminders:**
- Follow `.agentic/lib/checklists/implementing_feature.md`
- Keep commits atomic and descriptive
- Update documentation in same commit as code
- If stuck or need human decision, add to `.agentic/HUMAN_NEEDED.md`
