...
1. **Project health check:**
   - Review `.agentic/STATUS.md` - is it accurate and up-to-date?
   - Check `JOURNAL.md` - are entries recent and meaningful?
   - For Formal: Review `.agentic/spec/FEATURES.md` - do statuses match reality?
   - Check `.agentic/HUMAN_NEEDED.md` - any stale items?
...
6. **Spec consistency (Formal mode):**
   ...
   - Run: `python3 .agentic/lib/tools/consistency.py`
...
8. **Generate action items:**
   ...
   - Add high-priority items to `.agentic/HUMAN_NEEDED.md` if human decision needed

9. **Update project docs:**
   - Update `.agentic/STATUS.md` with insights
