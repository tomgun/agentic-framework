...
5. **For Formal mode - Create formal specs:**
   ...
   - Add features to `.agentic/spec/FEATURES.md` with:
     - Feature IDs (F-####)
     - Dependencies
     - Acceptance criteria
   - Create acceptance criteria files: `.agentic/spec/acceptance/F-####.md`
...
7. **Identify risks & unknowns:**
   ...
   - Add to `.agentic/HUMAN_NEEDED.md` if input needed
