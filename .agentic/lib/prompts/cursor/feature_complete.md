...
4. **Update `.agentic/spec/FEATURES.md`:**
   - Status: `shipped`
...
5. **Update documentation:**
   ...
   - `.agentic/STATUS.md`: Update current focus/next steps
   - User-facing docs (if needed): Update README, guides, etc.

6. **Final verification:**
   - Read the acceptance criteria file `.agentic/spec/acceptance/F-[XXXX].md`
   - Confirm each criterion is met
   - If anything is uncertain, add to `.agentic/HUMAN_NEEDED.md`
