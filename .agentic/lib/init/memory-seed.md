...
- **Capability catalog is universal**: FEATURES.md exists for all projects. Register what you build with `feature.sh cap add "Name" "Description"`. Claude hooks (Stop.sh, UserPromptSubmit) nudge if you write implementation code but forget to update FEATURES.md.
