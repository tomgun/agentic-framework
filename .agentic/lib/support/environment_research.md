...
**Recommended `.agentic/lib/claude-hooks/hooks.json`**:
```json
{
  "hooks": {
    "SessionStart": {
      "command": "bash .agentic/lib/claude-hooks/SessionStart.sh",
      "timeout": 5000
    },
    "PostToolUse": {
      "command": "bash .agentic/lib/claude-hooks/PostToolUse.sh",
      "timeout": 2000
    },
    "PreCompact": {
      "command": "bash .agentic/lib/claude-hooks/PreCompact.sh",
      "timeout": 10000
    },
    "Stop": {
      "command": "bash .agentic/lib/claude-hooks/Stop.sh",
      "timeout": 5000
    }
  }
}
...
## Checklists
- Before work: `.agentic/lib/checklists/session_start.md`
- After work: `.agentic/lib/checklists/session_end.md`
- Before "done": `.agentic/lib/checklists/feature_complete.md`

Full details: `.agentic/lib/agents/shared/agent_operating_guidelines.md`
```
...
**Framework strategy**:
- Shared core (`.agentic/lib/agents/shared/`)
