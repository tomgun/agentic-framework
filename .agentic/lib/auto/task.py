...
class TaskRunner:
    ...
    def _spawn_claude_implement(
        ...
        prompt = (
            ...
            f"  (fallback: .agentic/spec/acceptance/{feature_id}.md if contract not found)\n"
            ...
            f"- Verify contract/acceptance criteria exist at .agentic/spec/contracts/{feature_id}.yaml\n"
            f"  (or legacy .agentic/spec/acceptance/{feature_id}.md)\n"
