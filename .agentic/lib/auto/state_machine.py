...
class FeatureStateMachine:
    ...
    def transition(
        ...
        """Execute a state transition via FEATURES.md + feature.sh.
...
def main() -> int:
    ...
    # explicitly passed via --enforce.  profiles.conf defines
    # state_enforcement per profile (off for discovery, blocking for
