...
{
  "yaml.schemas": {
    "./.agentic/schemas/feature.schema.json": [".agentic/spec/FEATURES.md"]
  }
}
```
...
- Lessons/caveats:
  - <!-- link to .agentic/spec/LESSONS.md or notes -->
- Notes:
...
3. **Run validation**: `python3 .agentic/lib/tools/validate_specs.py`
4. **Fix errors** if any
