...
- Acceptance: .agentic/spec/acceptance/F-####.md  <!-- Link to acceptance criteria -->
- Verification:
  - Accepted: no       <!-- no | yes -->
...
- Technical debt:
  - <!-- links to .agentic/spec/LESSONS.md anchors or specific debt items -->
- Lessons/caveats:
  - <!-- link to .agentic/spec/LESSONS.md anchors or adr -->
- Notes:
...
- Dependencies: none
- Status: planned
- Acceptance: .agentic/spec/acceptance/F-####.md
- Implementation:
  - State: none
- Tests:
  - Unit: todo
