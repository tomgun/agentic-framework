...
- Update priorities in `.agentic/STATUS.md`
- Write acceptance criteria in a new `.agentic/spec/acceptance/F-####.md` file
- Create a task file
...
- Requirements: R-0008
- NFRs: none
- Acceptance: .agentic/spec/acceptance/F-0015.md
- Verification:
  - Accepted: no
- Implementation:
  - State: none
...
**File**: `.agentic/spec/acceptance/F-0015.md`
...
**File**: `.agentic/HUMAN_NEEDED.md` or create a task file
...
```bash
bash .agentic/lib/tools/task.sh "Evaluate notification systems"
```

### 5. Record a Decision (ADR)

**File**: `.agentic/spec/adr/ADR-0005-use-postgresql.md`
...
1. Reads `CONTEXT_PACK.md`, `.agentic/STATUS.md`, `JOURNAL.md`
2. Reads `.agentic/spec/FEATURES.md` for current features
...
1. Add F-0015 to `.agentic/spec/FEATURES.md`
2. Write `.agentic/spec/acceptance/F-0015.md` with criteria
...
2. Reads .agentic/spec/FEATURES.md for F-0015 details
3. Reads .agentic/spec/acceptance/F-0015.md for criteria
...
```bash
cat .agentic/spec/FEATURES.md           # See all features including yours
bash .agentic/lib/tools/report.sh   # Status summary
bash .agentic/lib/tools/deps.sh     # Check dependencies
```
