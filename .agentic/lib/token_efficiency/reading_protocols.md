...
2. **`.agentic/STATUS.md`** (≈300-800 tokens)
   - Current focus
   - What's in progress
   - Next steps
   - Known issues
...
1. **Feature's acceptance criteria** (≈500-1000 tokens)
   - Read `.agentic/spec/acceptance/F-####.md` for the specific feature
...
2. **Relevant spec sections** (≈1-2K tokens)
   ...
   - Read only the feature entry in `.agentic/spec/FEATURES.md`
   - Skip reading entire files

3. **NFRs if applicable** (≈300-500 tokens)
   - Only if feature has `NFRs:` listed
   - Read specific NFR entries, not entire `.agentic/spec/NFR.md`
...
1. Read .agentic/STATUS.md (check if F-0015 is current focus)
2. Read CONTEXT_PACK.md (where things are)
3. Read .agentic/spec/acceptance/F-0015.md
...
1. Read .agentic/STATUS.md, JOURNAL.md (context)
