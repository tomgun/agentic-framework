...
**Framework integration**: Our durable artifacts (`CONTEXT_PACK.md`, `.agentic/STATUS.md`, etc.) are designed to be added to Claude projects for caching.
...
**Framework integration**: `.agentic/STATUS.md` and session protocols help with planning.
