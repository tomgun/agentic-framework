...
bash .agentic/lib/tools/create-agent.sh my-domain-expert

# Example: create a game design agent
bash .agentic/lib/tools/create-agent.sh game-design
```
...
```
Create a research agent using the role defined in .agentic/lib/agents/roles/research_agent.md
```

See `.agentic/lib/agents/claude/sub-agents.md` for full setup instructions.
...
See `.agentic/lib/agents/cursor/agents-setup.md` for full setup instructions.
