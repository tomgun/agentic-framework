...
optional:
  - .agentic/lib/agents/shared/guidelines/anti-hallucination.md
  - .agentic/lib/agents/shared/guidelines/small-batch.md
exclude:
  - .agentic/lib/agents/shared/guidelines/multi-agent.md  # Not needed for single agent
```
