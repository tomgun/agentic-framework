...
See `.agentic/lib/workflows/documentation_verification.md` for setup and details.
...
bash .agentic/lib/tools/blocker.sh add "Install GUT plugin" "dependency" "Manual install via Asset Library"
```
