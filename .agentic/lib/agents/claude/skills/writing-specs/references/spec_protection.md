...
These gates have **no escape hatch** by design. If a modification is needed, create a migration documenting the change with `bash .agentic/lib/tools/migration.sh create "Evolve F-XXXX: [reason]"`.
