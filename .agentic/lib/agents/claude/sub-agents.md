...
```
Read .agentic/lib/agents/claude/subagents/orchestrator-agent.md and coordinate feature F-0042
```
...
```
The project has specialized agent roles defined in .agentic/lib/agents/claude/subagents/
...
Read .agentic/lib/agents/roles/ to understand available agents.
...
Use the role definition from .agentic/lib/agents/roles/research_agent.md
...
```
As Research Agent (see .agentic/lib/agents/roles/research_agent.md):
...
```
As Implementation Agent (see .agentic/lib/agents/roles/implementation_agent.md):
