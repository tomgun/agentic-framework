...
bash .agentic/lib/tools/context-for-role.sh implementation-agent F-0042 --dry-run

# Output shows:
# Token budget: 5000
# Tokens used: 3200 (64%)
# Files loaded: .agentic/spec/acceptance/F-0042.md, STACK.md, CONTEXT_PACK.md[entry_points]
```
...
**Context manifests**: `.agentic/lib/agents/context-manifests/` define what each role needs.
...
2. **Planning** → spawn planning-agent → creates .agentic/spec/acceptance/F-####.md
...
# FEATURES.md updated?
grep "F-####" .agentic/spec/FEATURES.md | grep -E "shipped|complete"

# No untracked files?
bash .agentic/lib/tools/check-untracked.sh
