...
### Feature Compliance
- [ ] Acceptance criteria exist (`.agentic/spec/acceptance/F-####.md`)
...
### Fixes Required
1. Run: `bash .agentic/lib/tools/feature.sh F-#### status shipped`
...
- Testing standards: `.agentic/lib/quality/testing_standards.md`
