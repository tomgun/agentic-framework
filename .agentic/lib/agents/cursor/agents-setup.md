...
**Full details**: `.agentic/lib/agents/shared/agent_operating_guidelines.md#agent-boundaries`
...
```bash
bash .agentic/lib/tools/setup-agent.sh cursor-agents
```
...
## Your Role
Read and follow: .agentic/lib/agents/roles/research_agent.md
...
```
Act as the Research Agent defined in .agentic/lib/agents/roles/research_agent.md
...
2. Act as Research Agent (.agentic/lib/agents/roles/research_agent.md)
...
## Instructions
See: .agentic/lib/agents/roles/implementation_agent.md
...
2. **Reference role files** - Always point to `.agentic/lib/agents/roles/`
...
```
Read and follow .agentic/lib/agents/roles/[agent].md
```
