...
cmd_auto() {
    ...
    case "$subcmd" in
        ...
        verify-framework)
            ...
            ;;
        tier-experiment)
            # Complexity tier experiments — compare discovery/formal/autonomous_formal (DEV-004)
        ...
        ""|--help)
            ...
            echo "  tier-experiment       Compare outcomes across discovery/formal/autonomous_formal (DEV-004)"
