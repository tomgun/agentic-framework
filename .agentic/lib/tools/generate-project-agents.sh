...
SPECIALIZATION_DIR="$AGENTS_LIB_DIR/specialization"
GENERIC_AGENTS_DIR="$AGENTS_LIB_DIR/claude/subagents"
PROJECT_AGENTS_DIR="$AGENTS_LIB_DIR/claude/subagents-project"
