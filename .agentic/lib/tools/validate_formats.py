...
def main() -> int:
    ...
    files_to_check = [
        (str(p.features_file.relative_to(repo_root)), validate_features_md),
        (str(p.journal_file.relative_to(repo_root)), validate_journal_md),
        (str(p.status_file.relative_to(repo_root)), validate_status_md),
        (str(p.human_needed_file.relative_to(repo_root)), validate_human_needed_md),
        (str(p.nfr_file.relative_to(repo_root)), validate_nfr_md),
    ]
