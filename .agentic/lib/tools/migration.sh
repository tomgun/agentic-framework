...
MIGEOF
  ...
  echo "  2. Update .agentic/spec/FEATURES.md (or run 'migration.sh apply')"
...
apply_migrations() {
  ...
  local features_file="$REPO_ROOT/.agentic/spec/FEATURES.md"
...
EOF
  ...
  echo "  mv spec/FEATURES.generated.md .agentic/spec/FEATURES.md"
  echo ""
}
