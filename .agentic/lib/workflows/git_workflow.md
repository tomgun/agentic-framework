...
2. **Present summary** to user:
   ...
   - Updated: .agentic/spec/FEATURES.md (marked F-0042 as complete)
...
| `.agentic/spec/FEATURES.md` | ✅ Read-only (check assigned features) | ⚠️ Only update your feature |
...
Agent: "I've implemented password validation (F-0042). Changes:
        ...
        - .agentic/spec/FEATURES.md: Marked F-0042 implementation complete
...
- `.agentic/lib/workflows/dev_loop.md` - Development workflow
- `.agentic/lib/workflows/multi_agent_coordination.md` - Detailed multi-agent protocol
- `.agentic/lib/init/STACK.template.md` - Configuration template
