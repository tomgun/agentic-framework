...
- [ ] **Feature has acceptance criteria**: Check `.agentic/spec/acceptance/F-####.md` exists (Formal) or informal criteria in `.agentic/OVERVIEW.md` (Discovery)
...
- Missing acceptance criteria → Add to `.agentic/HUMAN_NEEDED.md`, create criteria with human
...
- Unclear requirements → Discuss with human, update `.agentic/HUMAN_NEEDED.md`
...
### 1. Pick work
- Start from `.agentic/STATUS.md` (current focus / next up)
- Choose one small, testable task
- Read acceptance criteria from `.agentic/spec/acceptance/F-####.md`
...
- Update `.agentic/STATUS.md` (always)
- Update `.agentic/spec/FEATURES.md` test status as tests accumulate
...
**Acceptance criteria** (from `.agentic/spec/acceptance/F-0042.md`):
...
> "This project uses TDD mode. Follow `.agentic/lib/workflows/tdd_mode.md` instead of the standard dev loop."
...
Follow `.agentic/lib/workflows/tdd_mode.md` for the red-green-refactor cycle:
...
5. Add to `.agentic/HUMAN_NEEDED.md` if test setup is unclear
...
5. **Ask for help**: Add specific question to `.agentic/HUMAN_NEEDED.md` with:
   - Test code
   - Implementation code  
...
**Solutions**:
1. **Check acceptance criteria**: `.agentic/spec/acceptance/F-####.md` lists all required behavior
...
**Solutions**:
1. **Don't guess**: Add question to `.agentic/HUMAN_NEEDED.md` immediately
...
- Standard development loop: `.agentic/lib/workflows/dev_loop.md`
