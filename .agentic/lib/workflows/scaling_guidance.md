...
**Symptom**: `.agentic/spec/FEATURES.md` is becoming hard to navigate.
...
- Keep master index in `.agentic/spec/FEATURES.md` with links
- Update tooling (report.py, doctor.py) to scan multiple files

**How to suggest**:
```
".agentic/spec/FEATURES.md has 35 features. Consider splitting by domain for easier navigation:
...
Keep .agentic/spec/FEATURES.md as an index with links."
```

### NFR count > 15

**Symptom**: `.agentic/spec/NFR.md` covers many different concerns.
...
- Keep master index in `.agentic/spec/NFR.md`

**How to suggest**:
```
".agentic/spec/NFR.md has 18 NFRs across multiple categories. Consider organizing by concern:
...
**Consider**:
- Archive completed tasks to `.agentic/spec/tasks/archive/`
- Create milestone-based organization
- Review and cancel obsolete tasks

**How to suggest**:
```
".agentic/spec/tasks/ has 60 task files. Consider:
1. Archive completed tasks to .agentic/spec/tasks/archive/
...
**Symptom**: `.agentic/spec/adr/` directory is large, finding relevant ADRs is hard.

**Consider**:
- Create `.agentic/spec/adr/README.md` with categorized index
- Categories: architecture, infrastructure, dependencies, api-design, testing
- Consider archiving superseded ADRs to `.agentic/spec/adr/archive/`

**How to suggest**:
```
".agentic/spec/adr/ has 25 ADRs. Consider creating .agentic/spec/adr/README.md with categorized index:
...
4. Enforce review checklist (.agentic/lib/quality/review_checklist.md) in CI
...
**Good suggestion**:
1. State the symptom: ".agentic/spec/FEATURES.md has 35 entries"
...
The feature count has reached 35, which may make .agentic/spec/FEATURES.md harder to navigate.
...
```
**Observation**: .agentic/spec/FEATURES.md now has 40 features spanning authentication, 
...
Keep .agentic/spec/FEATURES.md as index with high-level summary and links.
...
## Related resources
- Agent operating guidelines: `.agentic/lib/agents/shared/agent_operating_guidelines.md`
- Token efficiency: `.agentic/token_efficiency/context_budgeting.md`
- Tool documentation: `.agentic/lib/tools/*.sh`
