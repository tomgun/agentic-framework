...
- `.agentic/spec/FEATURES.md` - Current state of all features
...
- `.agentic/spec/migrations/001_initial_features.md`
- `.agentic/spec/migrations/002_add_authentication.md`
- `.agentic/spec/migrations/003_refactor_payment.md`
...
- `.agentic/spec/FEATURES.md` - Added F-0042
- `.agentic/spec/NFR.md` - Added NFR-0015 (2s latency requirement)
...
```bash
# Manual
bash .agentic/lib/tools/migration.sh create "Add real-time notifications"

# Output: .agentic/spec/migrations/042_add_realtime_notifications.md
```

### Listing Migrations

```bash
bash .agentic/lib/tools/migration.sh list
...
```bash
bash .agentic/lib/tools/migration.sh show 42

# Displays: .agentic/spec/migrations/042_add_realtime_notifications.md
```
...
```bash
bash .agentic/lib/tools/migration.sh apply

# Reads all migrations in order
# Generates fresh .agentic/spec/FEATURES.md
```
...
**New**: 
```bash
bash .agentic/lib/tools/migration.sh search "payment"
