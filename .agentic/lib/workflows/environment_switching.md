...
"Read AGENTS.md and JOURNAL.md (last 3 entries).
 ...
 Use token-efficient scripts (.agentic/lib/tools/*)."
...
- `.agentic/STATUS.md` - Current state
- `.agentic/HUMAN_NEEDED.md` - Blockers

**All tools use**:
- Token-efficient scripts (`.agentic/lib/tools/*.sh`)
- Checklists (`.agentic/lib/checklists/*.md`)
- Quality standards (`.agentic/lib/quality/*.md`)
...
bash .agentic/lib/tools/feature.sh F-0003 status shipped  # 25 tokens!

# Instead of reading/rewriting JOURNAL.md (2000 tokens):
bash .agentic/lib/tools/journal.sh "..." "..." "..." "..."  # 50 tokens!
```
...
Cursor: bash .agentic/lib/tools/feature.sh F-0005 impl-state complete
...
Cursor: Docs update
Cursor: bash .agentic/lib/tools/feature.sh F-0005 status shipped
Cursor: bash .agentic/lib/tools/journal.sh "F-0005 complete" "..." "Start F-0006" "None"
```
...
bash .agentic/lib/tools/journal.sh "Checkpoint" "What done" "What next" "Blockers"
```
...
Before commit: bash .agentic/lib/tools/session_log.sh '...' '...' '...'"
```
...
```bash
bash .agentic/lib/tools/session_log.sh "Progress" "What done" "feature=F-####"
```
