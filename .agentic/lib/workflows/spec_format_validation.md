...
**File**: `.agentic/lib/tools/validate_specs.py`
...
def main():
    ...
    if not features_file.exists():
        print("No .agentic/spec/FEATURES.md found")
        return 0
...
jobs:
  validate:
    ...
    steps:
      ...
      - name: Validate specs
        run: python3 .agentic/lib/tools/validate_specs.py
```
...
```python
# .agentic/lib/tools/lint_specs.py
...
- If `spec_validation: enabled` in STACK.md:
  ...
  - Run `python3 .agentic/lib/tools/validate_specs.py` after editing
...
- Validation tools: `.agentic/lib/tools/validate_specs.py`, `lint_specs.py`
- Agent guidelines: `.agentic/lib/agents/shared/agent_operating_guidelines.md`
