...
See: `.agentic/lib/tools/validate_formats.py` (to be created)
...
- Via `bash .agentic/lib/tools/doctor.sh` (includes format check)
...
- Run `python3 .agentic/lib/tools/validate_formats.py` after init
