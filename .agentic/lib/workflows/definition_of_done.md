...
- All criteria in `.agentic/spec/acceptance/F-####.md` satisfied
...
- `FEATURES.md` or `.agentic/OVERVIEW.md` status = shipped
- `JOURNAL.md` updated
- `CONTEXT_PACK.md` updated (if architecture changed)
- Code comments explain "why"

### ✅ Quality Gates Pass
- `bash .agentic/lib/hooks/pre-commit-check.sh` succeeds
