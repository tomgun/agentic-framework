...
- ✅ `.agentic/spec/REFERENCES.md` (existing research)
...
4. Update `.agentic/spec/REFERENCES.md` with findings
5. Recommend approach OR escalate to `.agentic/HUMAN_NEEDED.md` if decision required
...
- Constraints: .agentic/spec/NFR.md (NFR-0002 security)
...
- ✅ `.agentic/spec/FEATURES.md` (existing features, dependencies)
- ✅ `.agentic/spec/NFR.md` (constraints)
- ❌ Implementation code
- ❌ Tests

**Responsibilities**:
1. Define feature in `FEATURES.md` (F-####, status: planned)
2. Write `.agentic/spec/acceptance/F-####.md` (detailed acceptance criteria)
...
- ADR (if needed): `.agentic/spec/adr/ADR-####-[title].md`
- Updated `TECH_SPEC.md` (if architecture changed)
- Updated `.agentic/STATUS.md` ("Next up" section)
...
**What was defined**:
- Feature: .agentic/spec/FEATURES.md (F-0042, status: planned, complexity: M)
- Acceptance criteria: .agentic/spec/acceptance/F-0042.md (6 ACs: AC1-AC6)
...
- Read: .agentic/spec/acceptance/F-0042.md (ALL 6 acceptance criteria)
...
**Loads**:
- ✅ `.agentic/spec/acceptance/F-####.md` (acceptance criteria - PRIMARY REFERENCE)
- ✅ `.agentic/spec/FEATURES.md` (feature definition)
...
- Read: .agentic/spec/acceptance/F-0042.md (if test expectations unclear)
...
2. Follow programming standards (see `.agentic/lib/quality/programming_standards.md`):
...
- Acceptance criteria: .agentic/spec/acceptance/F-0042.md
...
**Loads**:
- ✅ `.agentic/spec/acceptance/F-####.md` (acceptance criteria - PRIMARY CHECKLIST)
- ✅ Implementation code
- ✅ Test files
- ✅ `.agentic/lib/quality/review_checklist.md`
- ✅ `.agentic/lib/workflows/definition_of_done.md`
- ✅ `.agentic/spec/NFR.md` (if feature has NFR requirements)
- ❌ Research docs
- ❌ Planning docs
...
**Responsibilities**:
1. Update `.agentic/spec/FEATURES.md`:
...
- Updated `.agentic/STATUS.md` (reflects current state)
...
**Loads**:
- ✅ `.agentic/spec/FEATURES.md` (what was implemented)
- ✅ `spec/TECH_SPEC.md` (architecture)
...
- ✅ `.agentic/lib/workflows/git_workflow.md` (protocol)
...
**Specs** (5 files):
- .agentic/spec/FEATURES.md (updated, +45 lines)
- .agentic/spec/acceptance/F-0042.md (new, 120 lines)
- .agentic/spec/adr/ADR-0005-auth-strategy.md (new, 95 lines)
...
- .agentic/spec/NFR.md (NFR-0002: Security requirements)
