...
Goal: ship in **small, test-backed increments** while keeping `.agentic/STATUS.md` and specs trustworthy.
...
1. **Pick work**
   ...
   - Choose one small, testable task (create `/.agentic/spec/tasks/...` if useful).
...
7. **Review yourself**
   - Use `.agentic/lib/quality/review_checklist.md`.
8. **Update docs**
...
- If context window resets mid-implementation:
  - Check `.agentic/STATUS.md` "Current session state" section for immediate context
