...
**Documents**: `.agentic/spec/FEATURES.md`, `.agentic/spec/NFR.md`
...
**Documents**: `.agentic/STATUS.md`, `JOURNAL.md`, `.agentic/HUMAN_NEEDED.md`, `STACK.md`
...
**Documents**: `CONTEXT_PACK.md`, `spec/OVERVIEW.md`, `.agentic/spec/LESSONS.md`, ADRs, Retrospectives, Research docs
...
2. **Provide migration script** (if needed):
   ```bash
   bash .agentic/lib/tools/migrate_formats.sh --from 0.1.0 --to 0.2.0
   ```
...
```bash
python3 .agentic/lib/tools/validate_formats.py [--strict] [--file PATH]
```
