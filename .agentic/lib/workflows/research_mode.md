...
2. **Do we need standard or custom implementation?**
   ...
   - **See `.agentic/lib/quality/library_selection.md` for decision framework**
...
- Link from `.agentic/spec/REFERENCES.md`
- Link from related ADRs, features, or HUMAN_NEEDED items

**Update project docs:**
- Add to `.agentic/spec/REFERENCES.md` if external resources are key
- Update `.agentic/STATUS.md` if decisions are needed
- Create `.agentic/HUMAN_NEEDED.md` entry if human decision required
...
- Actions created:
  ...
  - Updated .agentic/spec/REFERENCES.md
...
- Retrospective workflow: `.agentic/lib/workflows/retrospective.md`
- Research templates: `.agentic/support/docs_templates/research_RESEARCH_TOPIC.md`
- External references: `.agentic/spec/REFERENCES.md`
- Architecture decisions: `.agentic/spec/adr/`
