...
1. Read acceptance criteria from `.agentic/.agentic/spec/acceptance/F-XXXX.md` if available
...
Steps taken:
1. Read .agentic/.agentic/spec/acceptance/F-0125.md — 4 criteria listed
